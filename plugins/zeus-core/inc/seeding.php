...
function zeus_seed_pages() {
	...
	$pages = array(
		...
		'about'                     => array( 'title' => 'About', 'content' => '<p>ZEUS Cabinets & Countertops designs and builds kitchen and bathroom cabinetry and countertops for homeowners across Orlando and Central Florida — in-stock collections for fast turnaround, and custom cabinetry for spaces that need an individual solution.</p><h2>How We Work</h2><p>Design, cabinetry, and countertops are planned and coordinated together by ZEUS, around how you actually use your space.</p><h2>Where We Work</h2><p>ZEUS is a service-area business serving Orlando, Windermere, Winter Garden, Horizon West, Clermont, and Dr. Phillips.</p><p><a href="/consultation/">Request a free consultation</a> to start your project.</p>', 'parent' => 0 ),
